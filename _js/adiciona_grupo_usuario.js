...
Objetivo: Adiciona grupos (empresas) para os usuarios acessarem o sistema
...
$('#enviar').click(function(){
	...
	$.ajax({
		method: 'POST',
		url: '/validaAdicionaGrupoUsuario',
		data : {nome: nome}
	}).done(function(data){
				...
				if($('input.checados').is(':checked')){
						...
						$.ajax({
								...
								data: {nome: nome, grupos: dados}
									...
									alert('Erro ao incluir os grupos');
								});
							} else {
